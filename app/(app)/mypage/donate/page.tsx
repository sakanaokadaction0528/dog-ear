    ...
    <div>
      ...
      <div className="px-4 pt-6 pb-12 space-y-6 max-w-lg mx-auto">
        ...
        <div className="bg-card border border-border rounded-xl p-5 space-y-4 text-sm text-foreground leading-relaxed">
          <p>いつもご利用いただきありがとうございます。このアプリの作者です。</p>
          <p>突然ですが、作者はアプリ開発は好きなのに、収益化と経営がびっくりするほど下手です。<br />このアプリの開発にはそれなりにお金をかけており、AI機能を使うたびに実はコストも発生しています。現在はまだユーザー数が少ないため、なんとか作者の自腹で運営しています。</p>
          <p>もしこのアプリを「ちょっと応援してもいいよ」と思っていただけましたら、協賛・寄付という形でご支援いただけると本当に助かります。</p>
          <p>いただいたご支援は、アプリの改善・AI機能の維持・作者のメンタル保護に大切に使わせていただきます。</p>
          <p>無理のない範囲で、応援していただけると嬉しいです。今後ともよろしくお願いいたします。</p>
        </div>
